...
object PrototypeLessons : LessonRepository {
    ...
    override val lessons = listOf(
        ...
        level(2, "Everyday nouns",
            ...
            build("2-6", "This is a book.", listOf("これは~kore wa", "ほん~hon", "です~desu"))),
        level(3, "Food & drink",
            ...
            build("3-4", "I eat bread.", listOf("わたしは~watashi wa", "パンを~pan o", "たべます~tabemasu"), "みず~mizu", "ねこ~neko"),
        ...
        level(4, "Simple actions",
            ...
            build("4-4", "I listen to music.", listOf("わたしは~watashi wa", "おんがくを~ongaku o", "ききます~kikimasu"), "みずを~mizu o", "たべます~tabemasu"),
        ...
        level(5, "Identity",
            ...
            build("5-3", "I am a student.", listOf("わたしは~watashi wa", "がくせい~gakusei", "です~desu"), "せんせい~sensei"),
        ...
        level(6, "Questions",
            ...
            build("6-6", "Where is the shop?", listOf("みせは~mise wa", "どこ~doko", "ですか~desu ka"))),
        level(7, "Likes",
            forward("7-1", "すき~suki", "Like", "Read", "Go", "Drink"),
            build("7-2", "I like cats.", listOf("わたしは~watashi wa", "ねこが~neko ga", "すきです~suki desu"), "いぬが~inu ga"),
        ...
        level(8, "Places & movement",
            ...
            build("8-4", "I go to the shop.", listOf("わたしは~watashi wa", "みせに~mise ni", "いきます~ikimasu"), "えきに~eki ni"),
        ...
        level(9, "Mini conversations",
            ...
            build("9-5", "I read a book.", listOf("わたしは~watashi wa", "ほんを~hon o", "よみます~yomimasu"), "みずを~mizu o", "いきます~ikimasu"),
        ...
        level(10, "Mixed challenge",
            ...
            build("10-3", "I like music.", listOf("わたしは~watashi wa", "おんがくが~ongaku ga", "すきです~suki desu"), "えいがが~eiga ga", "のみます~nomimasu"),
